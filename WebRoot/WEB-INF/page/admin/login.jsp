...
<body>
	<div style="width: 100%;height: 100px;display: flex;">
		<div style="width: 1200px;margin: 20px auto;">
			<a href="#">
				<img src="../static/javaex/pc/images/logo.png" />
			</a>
		</div>
	</div>
<!--中间主体信息-->
	<div class="login-bg">
		<!--表单-->
		<form id="login"" ><!--  action="${pageContext.request.contextPath }/admin/loginTest.action -->
			<div class="login-form">
			<!--标题-->
			<div class="login-title">登录后台</div>
			<!--用户名-->
			<div class="login-item">
				<input type="text" class="login-text" id="login_name" name="id" data-type="必填" placeholder="用户名" />
			</div>
			<!--密码-->
			<div class="login-item">
			...
			$.ajax({
				...
				success : function(rtn) {
					if(rtn=="0")
						...
						addErrorMsg("login_name", "用户名或密码为空")
						else if(rtn=="111")
							addErrorMsg("login_name", "用户名或密码不正确")
